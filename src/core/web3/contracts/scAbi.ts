...
export const SCPolygon3Sale_ABI = [
  {
    inputs: [
      {
        internalType: "uint256",
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        internalType: "struct RoyaltyInfo[]",
        name: "secondaryRoyalityInfo",
        type: "tuple[]",
      },
      {
        internalType: "uint256",
        name: "royalityBasisPoints",
        type: "uint256",
      },
    ],
